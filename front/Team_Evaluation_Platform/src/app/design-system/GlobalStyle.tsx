export function GlobalStyle() {
  return (
    <style>{`
      ...
      @keyframes starBreathe { 0%,100%{transform:scale(1)} 50%{transform:scale(1.12)} }
      @keyframes slideInPanel { from{opacity:0;transform:translateX(48px)} to{opacity:1;transform:translateX(0)} }
      @keyframes spinSlowC { to{transform:translate(-50%,-50%) rotate(360deg)} }
      @keyframes pulseRing { 0%{transform:translate(-50%,-50%) scale(.7);opacity:.8} 100%{transform:translate(-50%,-50%) scale(2);opacity:0} }
