...
public class StarController {
    ...
    @GetMapping
    public ApiResponse<List<StarSummaryResponse>> getStars(
            @AuthenticationPrincipal AuthenticatedUser authenticatedUser,
            @RequestParam(name = "includeUnregistered", defaultValue = "false") boolean includeUnregistered
    ) {
        return ApiResponse.success(starService.getStars(authenticatedUser.id(), includeUnregistered));
    }
