...
* [v] 로그인 및 최초 로그인 시 비밀번호 변경
* [v] 프로필 사진, 초기 능력치, 한 줄 자기소개 설정
* [v] 팀 생성 및 초대 코드 기반 팀 참여
* [v] 팀원 목록 조회
* [ ] 프로젝트 종료 후 팀원 상호 평가
...
* [v] 참가자 카드 도감 조회
* [v] 카드 앞면(프로필, 이름, 대표 칭호, 육각형 그래프) 표시
* [v] 카드 뒷면(상세 능력치, 칭호 목록, 자기소개) 표시
* [v] 개별 카드 AI 질문
* [v] 여러 참가자를 선택한 팀 조합 및 카드 비교 AI 분석
* [ ] AI 대화 내역 저장 및 이전 대화를 이어가는 채팅 기능


### 선택 기능

* [v] 카드 검색 및 이름/능력치/칭호별 필터링
* [v] 카드 정렬(이름순, 능력치순 등)
* [v] 카드 Flip 애니메이션 및 게임 스타일 UI
* [ ] 평가 진행률 표시
* [ ] 평가 완료 시에만 카드 상세 및 AI 기능 열람 가능(잠금 기능)
* [ ] AI 질문 및 답변 기록 조회
* [v] AI 응답 스트리밍 및 로딩 애니메이션
